...
const compressor_handler = (() => {
  // private scope for section 01 — no name collisions possible
...
const controlValve_handler = (() => {
  // private scope for section 02 — no name collisions possible
...
const coolingTower_handler = (() => {
  // private scope for section 03 — no name collisions possible
...
const eos_handler = (() => {
  // private scope for section 04 — no name collisions possible
  // Route: /api/eos
  // Source: eos.js
  // ══════════════════════════════════════════════════════════════════════════════
...
const fan_handler = (() => {
  // private scope for section 05 — no name collisions possible
  // Route: /api/fan
  // Source: fan.js
  // ══════════════════════════════════════════════════════════════════════════════
...
const heatxpert_handler = (() => {
  // private scope for section 06 — no name collisions possible
  // Route: /api/heatxpert
  // Source: heatxpert.js
  // ══════════════════════════════════════════════════════════════════════════════
...
const orificeFlow_handler = (() => {
  // private scope for section 07 — no name collisions possible
...
const pressureDrop_handler = (() => {
  // private scope for section 08 — no name collisions possible
...
const psychrometric_handler = (() => {
  // private scope for section 09 — no name collisions possible
...
const pump_handler = (() => {
  // private scope for section 10 — no name collisions possible
  // Route: /api/pump
  // Source: pump.js
  // ══════════════════════════════════════════════════════════════════════════════
...
const rankine_handler = (() => {
  // private scope for section 11 — no name collisions possible
  // Route: /api/rankine
  // Source: rankine (1).js
  // ══════════════════════════════════════════════════════════════════════════════
...
const steamQuench_handler = (() => {
  // private scope for section 12 — no name collisions possible
...
const steamTurbine_handler = (() => {
  // private scope for section 13 — no name collisions possible
...
const steam_handler = (() => {
  // private scope for section 14 — no name collisions possible
  // Route: /api/steam
  // Source: steam.js
  // ══════════════════════════════════════════════════════════════════════════════
...
const vesselSeparator_handler = (() => {
  // private scope for section 15 — no name collisions possible
...
const npsh_handler = (() => {
  // private scope for section 16 — no name collisions possible
...
const civil_handler = (() => {
  // private scope for section 17 — no name collisions possible
...
const instrumentation_handler = (() => {
  // private scope for section 18 — no name collisions possible
...
const electrical_handler = (() => {
  // private scope for section 19 — no name collisions possible
...
const mechanical_handler = (() => {
  // private scope for section 20 — no name collisions possible
...
const moc_handler = (() => {
  // private scope for section 21 — no name collisions possible
  // Route: /api/moc
  // Source: moc.js
  // ══════════════════════════════════════════════════════════════════════════════
